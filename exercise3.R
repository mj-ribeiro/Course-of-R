...
Salary['JoeJohnson', '2014']   # salary of the JoeJohnson in 2014
...
which(gpg %in% max(gpg['KobeBryant', ]))    #return the position of maximum
r = colnames(gpg)             
r[1]                         # maximum KobeBryant goals per game was in 2005
...
x = c(1, 44, 6, 33, 0, 1)
x[c(1,3)] #take the first and third element of vector x

##

Games
Games[1:3, 1:6]   #by index
Games[c(5, 10), c(9, 10)]
Games[ , c('2008', '2011')]    #by name of columns
Games[ c('KobeBryant', 'ChrisBosh') , c('2008', '2011')]  #by name of columns and rows
